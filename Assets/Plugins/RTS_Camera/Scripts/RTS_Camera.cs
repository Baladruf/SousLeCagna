...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float SetZoomPos { set { zoomPos = value; } }
        #endregion
        ...
        private void HeightCalculation()
        {
            ...
            if(useScrollwheelZooming)
                zoomPos += ScrollWheel * Time.deltaTime * scrollWheelZoomingSensitivity * -1;
            if (useKeyboardZooming)
                zoomPos += ZoomDirection * Time.deltaTime * keyboardZoomingSensitivity * -1;
            ...
            if(distanceToGround != targetHeight && distanceToGround != 0) // balad
        ...
        private float DistanceToGround()
        {
            ...
            RaycastHit hit;
            if (Physics.Raycast(ray, out hit, Mathf.Infinity, groundMask.value)) // Balad
